...
<jsp:include page="navbar2.jsp"></jsp:include>
   ...
   <div class="container">
        ...
        <div class="welcome-message">Sei nella Creazione Categoria</div>
      
         <p id="info"> Qui sotto puoi creare una nuova categoria di prodotti </p>
    ...
    <div class="container" id="contabella" style="padding-bottom: 20rem;">
       <form action="<%=request.getContextPath() +"/CreaCategoria" %>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nome">Nome:</label>
                <input type="text" id="nome" name="<%=Costanti.CATEGORIA_NOME%>" >
            </div>
               <div class="form-group">
            ...
            <div>
            <input type="submit" id="creacategoria" class="subbtn"  value="Crea categoria">
