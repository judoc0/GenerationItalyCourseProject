...
<jsp:include page="navbar2.jsp"></jsp:include>
   ...
   <div class="container">
        ...
        <div class="welcome-message">Sei nella Creazione Prodotto</div>
      
         <p id="info"> Qui sotto puoi creare un nuovo prodotto </p>
    ...
    <div class="container">
       <form action="<%=request.getContextPath() +"/CreaProdotto" %>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" id="nome" name="<%=Costanti.NOME_PRODOTTO %>" >
            </div>
            <div class="form-group">
             	<label for="myTextArea">Descrizione:</label>
    			<textarea id="myTextArea" name="<%=Costanti.DESCRIZIONE_PRODOTTO %>" rows="4" cols="50"></textarea>
             </div>
            <div class="form-group">
                <label for="prezzo">Prezzo:</label>
                <input type=number id="prezzo" step="0.01" name="<%=Costanti.PREZZO_PRODOTTO %>" required  min="0">
            </div>
            <div class="form-group">
                <label for="disponibilità">Disponibilità:</label>
                <input type="number" id="disponiilità" name="<%=Costanti.DISPONIBILITA_PRODOTTO%>" required min="0">
            </div>
            <div class="form-group">
            ...
            <div>
                <input type="submit" id="creaprodotto" class="subbtn"  value="Crea prodotto">
            </div>
        </form>
        <br>
        <br>
