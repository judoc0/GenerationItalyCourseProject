...
<head>
    <meta charset="UTF-8">
    <title>Creazione Fornitore</title>
...
<jsp:include page="navbar2.jsp"></jsp:include>
   ...
   <div class="container">
        ...
        <div class="welcome-message">Sei nella Creazione Fornitore</div>
      
         <p id="info"> Qui sotto puoi creare un nuovo fornitore </p>
    ...
    <div class="container" id="contabella" style="padding-bottom: 22rem;">
       <form action="<%=request.getContextPath() +"/CreaFornitore" %>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nome">Nome:</label>
                <input type="text" id="nome" name="<%=Costanti.FORNITORE_NOME %>" >
            </div>
                <div class="form-group">
            ...
            <div>
                <input id="creacategoria" class="subbtn" type="submit" value="Crea fornitore">
            </div>
        </form>
          </div>
    </div>
