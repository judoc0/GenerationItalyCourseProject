...
<div class="container mt-5" style="min-height: 76.2vh;">
      ...
      <div class="row">
        <div class="col-lg-6 col-6">
          ...
          <div class="col-lg-6 col-6 text-right" style="display: flex;">
        <a id="catforn" style="border-radius: 10px; margin-left: 10vw; margin-right: 4.6vw" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
            Categorie
        </a>
     ...
     <div class="col-lg-6 col-6 mt-3 text-right" style="display: flex">
          <a href="<%= "http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/CreazioneProdotto"%>" id="view" class="btn viewmore">Crea Prodotto</a>
    
        
     
          <a href="<%= "http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/Categoria"%>" id="view" class="btn viewmore" style="margin-left: 3vw;">Vedi Categorie</a>
   
        
    
          <a href="<%= "http://" + request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/Fornitore"%>" id="view" class="btn viewmore" >Vedi Fornitori</a>
      ...
      <%
		...
		for (Prodotto prodotto : catalogo) {
			...
			for(Ordine_Prodotto ordine_Prodotto : ordine_Prodottos) {
				if(prodotto.getId() == ordine_Prodotto.getProdotto().getId())
					venduti += ordine_Prodotto.getQuantita();
			}
	  %>
        <div class="col-lg-2 col-6 mt-5 mb-5" id="pepega<%= counter %>">
        <a href="VediProdotto?<%=Costanti.PRODOTTO_ID%>=<%=prodotto.getId()%>">
          <img style="border-radius:10px; box-shadow: 10px 5px 10px rgba(0, 0, 0, 0.8);" src="<%=mappa.get(prodotto.getId()) %>" width="80%">
        </a>  
          	<form action="<%=request.getContextPath()+ "/AddCarrello"%>">
          		<p id="productName<%= counter %>" class="text-center mt-1"> <%=prodotto.getNome() %><br>Unità vendute: <span style="color: yellow"><%=venduti %></span></p>
				...
				<button class="btn btn-primary" id="ii"><i class="fa-solid fa-cart-plus"></i></button>
				<% }%>
			</form>
        ...
        <div id="bottoniprodotti" style="margin-top: <%=top+"vh"%>">      
        <form action="<%=request.getContextPath()+"/ModificaRedirect"%>">
			<input type="hidden" name=<%=Costanti.PRODOTTO_ID%> value=<%=prodotto.getId()%>>
			<button id="bottoni" class="subbtn" type="submit">Modifica</button>
		</form>	
        
        <form action="<%=request.getContextPath()+"/EliminaProdotto"%>">
			<input type="hidden" name=<%=Costanti.PRODOTTO_ID%> value=<%=prodotto.getId()%>>
			<button id="bottoni2" class="subbtn" type="submit">&nbspElimina&nbsp </button>
		</form>		
  ...
  <img src="<%=request.getContextPath() %>/Media/confused.gif" style="margin-left: 58vh; width: 460px" alt="Nessun risultato" id="noHover">
</div>
<div id="noRiccardo" style="display: none;">
  <img src="<%=request.getContextPath() %>/Media/clown-nose.gif" style="margin-left: 50vh; margin-top: 5vh;" alt="CLOWN" id="noHover">
</div>
<div id="jean" style="display: none;">
  <img src="<%=request.getContextPath() %>/Media/cat.gif" style="margin-left: 60vh; margin-top: 5vh; width: 400px" alt="cat" id="noHover">
</div>
<div id="francesca" style="display: none;">
  <img src="<%=request.getContextPath() %>/Media/francesca.gif" style="margin-left: 60vh; margin-top: 5vh; width: 400px" alt="cat" id="noHover">
</div>
<div id="sonia" style="display: none;">
  <img src="<%=request.getContextPath() %>/Media/SONIA.gif" style="margin-left: 60vh; margin-top: 5vh; width: 400px" alt="cat" id="noHover">
</div>
<div id="alessandro" style="display: none;">
  <img src="<%=request.getContextPath() %>/Media/ALE.gif" style="margin-left: 60vh; margin-top: 5vh; width: 400px" alt="cat" id="noHover">
</div>
<div id="giovanni" style="display: none;">
  <img src="<%=request.getContextPath() %>/Media/DOPPIAG.jpg" style="margin-left: 66vh; width: 300px" alt="cat" id="noHover">
</div>
</div>
