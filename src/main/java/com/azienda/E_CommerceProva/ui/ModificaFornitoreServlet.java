...
public class ModificaFornitoreServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Integer id = Integer.parseInt(req.getParameter(Costanti.FORNITORE_ID));
			...
			sv.updateFornitore(id, nome, immagine, nomeImmagine);
