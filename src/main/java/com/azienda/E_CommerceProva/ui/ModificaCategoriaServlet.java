...
public class ModificaCategoriaServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Integer id = Integer.parseInt(req.getParameter(Costanti.CATEGORIA_ID));
			
			String nome = req.getParameter(Costanti.CATEGORIA_NOME);
			...
			sv.updateCategoria(id, nome, immagine, nomeImmagine);
