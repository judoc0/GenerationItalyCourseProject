...
public class FornitoreServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			List<Fornitore> fornitori = sv.findAllFornitori();
			
			aggiungiImmaggini(fornitori, req);
			req.setAttribute(Costanti.LISTA_FORNITORI, fornitori);

			req.getRequestDispatcher("/Jsp/Fornitori.jsp").forward(req, resp);
	...
	public void aggiungiImmaggini(List<Fornitore> prodotti, HttpServletRequest request) throws Exception {
		...
		for (Fornitore prodotto : prodotti) {
