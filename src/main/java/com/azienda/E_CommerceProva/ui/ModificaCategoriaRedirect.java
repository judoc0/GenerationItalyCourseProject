...
@WebServlet("/ModificaCategoriaRedirect")
public class ModificaCategoriaRedirect extends HttpServlet{
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Categoria p = sv.findCategoriaById(Integer.parseInt((req.getParameter(Costanti.CATEGORIA_ID))));
			
			req.setAttribute(Costanti.CATEGORIA, p);
					
			
			req.getRequestDispatcher("/Jsp/ModificaCategoria.jsp").forward(req, resp);
		} 	catch (Exception e) {
