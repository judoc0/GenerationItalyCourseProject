...
@WebServlet("/ModificaFornitoreRedirect")
public class ModificaFornitoreRedirect extends HttpServlet{
	@Override
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Fornitore p = sv.findFornitoreById(Integer.parseInt((req.getParameter(Costanti.FORNITORE_ID))));
			
			req.setAttribute(Costanti.FORNITORE, p);
					
			
			req.getRequestDispatcher("/Jsp/ModificaFornitore.jsp").forward(req, resp);
		} 	catch (Exception e) {
