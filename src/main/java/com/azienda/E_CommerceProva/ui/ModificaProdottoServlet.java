...
public class ModificaProdottoServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			Integer id = Integer.parseInt(req.getParameter(Costanti.PRODOTTO_ID));
			...
			sv.updateProdotto(id, nome, prezzo, descrizione, disponibilita, categoria, fornitore, immagine, nomeImmagine);
			
			resp.sendRedirect("http://" + req.getServerName() + ":" + req.getServerPort() + req.getContextPath() + "/Catalogo");
			//req.getRequestDispatcher("/Catalogo")
